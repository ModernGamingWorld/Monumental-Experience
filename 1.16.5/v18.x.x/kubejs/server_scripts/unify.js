onEvent('recipes', e => {
	...
	materials = [{
		...
		ingot: 'bigreactors:graphite_ingot',

		storage_block: 'bigreactors:graphite_block',
		...
		nugget: 'inventorypets:nugget_diamond',
		...
		gem: 'emendatusenigmatica:certus_quartz_gem',

		dust: 'emendatusenigmatica:certus_quartz_dust',

		block: 'emendatusenigmatica:certus_quartz_block'

	}, {

		name: 'charged_certus_quartz',

		gem: 'emendatusenigmatica:charged_certus_quartz_gem',

		dust: 'emendatusenigmatica:charged_certus_quartz_dust',

		block: 'emendatusenigmatica:charged_certus_quartz_block'

	}, {

		name: 'fluix',

		gem: 'emendatusenigmatica:fluix_gem',

		dust: 'emendatusenigmatica:fluix_dust',
	...
	e.replaceInput('ars_nouveau:arcane_ore', '#forge:ores/mana')

	// Mana

	e.replaceInput('ars_nouveau:mana_gem_block', '#forge:storage_blocks/arcane')

	// Fluix

	e.replaceOutput('appliedenergistics2:fluix_block', '#forge:storage_blocks/fluix')

	e.replaceInput('appliedenergistics2:fluix_block', '#forge:storage_blocks/fluix')

	// Certus Quartz

	e.replaceOutput('appliedenergistics2:quartz_block', '#forge:storage_blocks/certus_quartz')

	e.replaceInput('appliedenergistics2:quartz_block', '#forge:storage_blocks/certus_quartz')

	e.replaceOutput('appliedenergistics2:quartz_ore', '#forge:ores/certus_quartz')

	e.replaceInput('appliedenergistics2:charged_quartz_ore', '#forge:ores/certus_quartz')

	// Bitumen

	e.replaceOutput('#forge:bitumen', 'emendatusenigmatica:bitumen_gem')

	e.replaceInput('#forge:bitumen', '#forge:bitumen')

	e.replaceInput('immersivepetroleum:bitumen', '#forge:bitumen')

	// Cast Iron

	e.replaceOutput('#steampowered:cast_iron_ingot', '#forge:ingots/cast_iron')

	// Coal coke item (block and dust above)

	e.replaceOutput('#forge:coal_coke', 'emendatusenigmatica:coke_gem')

	e.replaceInput('#forge:coal_coke', '#forge:coal_coke')

	// Dimensional Shards

	e.replaceOutput('rftoolsbase:dimensionalshard', 'emendatusenigmatica:dimensional_gem')

	e.replaceInput('rftoolsbase:dimensionalshard', ['rftoolsbase:dimensionalshard', 'emendatusenigmatica:dimensional_gem'])

	// ENDER

	e.replaceOutput('#forge:dusts/ender', 'emendatusenigmatica:ender_dust')

	e.replaceOutput('#forge:dusts/ender_pearl', 'emendatusenigmatica:ender_dust')

	e.replaceOutput('appliedenergistics2:ender_dust', 'emendatusenigmatica:ender_dust')

	e.replaceOutput('thermal:ender_pearl_dust', 'emendatusenigmatica:ender_dust')

	e.replaceInput('thermal:ender_pearl_dust', '#forge:dusts/ender_pearl')

	e.replaceInput('thermal:ender_pearl_dust', '#forge:dusts/ender')

	e.replaceInput('appliedenergistics2:ender_dust', '#forge:dusts/ender_pearl')

	e.replaceInput('appliedenergistics2:ender_dust', '#forge:dusts/ender')

	// Slag

	e.replaceOutput('#forge:slag', 'thermal:slag')

	e.replaceInput('#forge:slag', '#forge:slag')

	// Silicon

	e.replaceOutput('#forge:silicon', 'emendatusenigmatica:silicon_gem')

	e.replaceInput('#forge:silicon', '#forge:silicon')

	// Sheetmetal

	e.replaceOutput('createdeco:copper_sheet_metal', '#forge:sheetmetals/copper')

	e.replaceInput('createdeco:copper_sheet_metal', '#forge:sheetmetals/copper')

	e.replaceOutput('createdeco:iron_sheet_metal', '#forge:sheetmetals/iron')

	e.replaceInput('createdeco:iron_sheet_metal', '#forge:sheetmetals/iron')

	e.replaceOutput('createdeco:gold_sheet_metal', '#forge:sheetmetals/gold')

	e.replaceInput('createdeco:gold_sheet_metal', '#forge:sheetmetals/gold')

	// Flour

	e.replaceOutput('pneumaticcraft:wheat_flour', 'create:wheat_flour')

	e.replaceInput('pneumaticcraft:wheat_flour', 'create:wheat_flour')
	...
	additionsrecipes.forEach(element => e.remove({ id: element }))
