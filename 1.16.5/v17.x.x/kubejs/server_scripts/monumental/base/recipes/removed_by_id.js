onEvent('recipes', event => {
    ...
    //Alternacraft
    event.remove({
        id: 'alternacraft:painite_pickaxe'
    })
    //Atum
    event.remove({
    ...
    event.remove({
        id: 'appliedenergistics2:tools/certus_quartz_shovel'
    })
    event.remove({
    ...
    event.remove({
        id: 'appliedenergistics2:tools/nether_quartz_shovel'
    })
    event.remove({
    ...
    event.remove({
        id: 'appliedenergistics2:network/parts/planes_annihilation'
    })
    event.remove({
    ...
    event.remove({
        id: 'astralsorcery:altar/enchantment_amulet_init'
    })
    event.remove({
    ...
    //Better Animals Plus
    event.remove({
        id: 'betteranimalsplus:blubber_torch'
    })
    //Building Gadgets
    event.remove({
    ...
    event.remove({
        id: 'createaddition:compat/immersiveengineering/blastingfurnace_preheater'
    })
    //Create
    event.remove({
    ...
    event.remove({
        id: 'create:blasting/lead_ingot_compat_eidolon'
    })
    event.remove({
    ...
    event.remove({
        id: 'create:smelting/ingot_lead_compat_mekanism'
    })
    //Decorative Blocks
    event.remove({
        id: 'decorative_blocks:torches_from_chandelier'
    })
    //DruidCraft
    event.remove({
    ...
    event.remove({
        id: 'immersiveengineering:crafting/blastingfurnace_preheater'
    })
    event.remove({
    ...
    event.remove({
        id: 'immersiveengineering:crafting/ingot_copper_from_smelting'
    })
    event.remove({
    ...
    event.remove({
        id: 'mysticalagriculture:essence/appliedenergistics2/calculation_press'
    })
    event.remove({
    ...
    event.remove({
        id: 'mysticalagradditions:insanium_essence_uncraft'
    })
    ...
    event.remove({
        id: 'mysticalagriculture:imperium_farmland_till'
    })
    event.remove({
    ...
    event.remove({
        id: 'mysticalagriculture:prudentium_farmland_till'
    })
    event.remove({
        id: 'mysticalagriculture:supremium_farmland_till'
    })
    event.remove({
    ...
    event.remove({
        id: 'mysticalagriculture:tertium_farmland_till'
    })
    event.remove({
    ...
    event.remove({
        id: 'mysticalagradditions:prosperity_apple'
    })
    event.remove({
        id: 'mysticalagradditions:soulium_apple'
    })
    event.remove({
    ...
    event.remove({
        id: 'mekanism:tier_installer/advance'
    })
    event.remove({
    ...
    event.remove({
        id: 'mekanism:metallurgic_infuser/alloy/infused'
    })
    event.remove({
    ...
    //Mekanism Gen
    event.remove({
        id: 'mekanismgenerators:flamethrower'
    })
    event.remove({
    ...
    event.remove({
        id: 'mekanismgenerators:generator/advanceed_solar'
    })
    event.remove({
    ...
    event.remove({
        id: 'refinedstorage:1024k_storage_part'
    })
    event.remove({
        id: 'refinedstorage:4096k_storage_part'
    })
    event.remove({
    ...
    event.remove({
        id: 'thermal:storage/copper_ingot_from_ingot'
    })
    event.remove({
    ...
    event.remove({
        id: 'thermal:smelting/lead_from_dust_from_blasting'
    })
    //Twilight Forest
    event.remove({
    ...
    event.remove({
        id: 'undergarden:smogstem_torch_ditchbulb'
    })
    event.remove({
