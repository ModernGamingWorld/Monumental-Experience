onEvent('server.datapack.high_priority', (event) => {
    let loot_table = {
        pools: [{
            ...
            entries: [{
                ...
                {
                    type: "item",
                    name: "iceandfire:ice_dragon_blood",
                    functions: [{
                        function: "set_count",
                        count: {
                            min: 1,
                ...
                {
                    type: "item",
                    name: "iceandfire:ice_dragon_heart",
                    functions: [{
                        function: "set_count",
                        count: {
                            min: 1,
                ...
                {
                    type: "item",
                    name: "iceandfire:ice_dragon_flesh",
                    functions: [{
                        function: "set_count",
                        count: {
                            min: 1,
                ...
                {
                    type: "item",
                    name: "iceandfire:dragonarmor_iron_head",
                    functions: [{
                        function: "set_count",
                        count: {
                            min: 1,
                ...
                {
                    type: "item",
                    name: "iceandfire:dragonarmor_iron_neck",
                    functions: [{
                        function: "set_count",
                        count: {
                            min: 1,
                ...
                {
                    type: "item",
                    name: "iceandfire:dragonarmor_iron_body",
                    functions: [{
                        function: "set_count",
                        count: {
                            min: 1,
                ...
                {
                    type: "item",
                    name: "iceandfire:dragonarmor_iron_tail",
                    functions: [{
                        function: "set_count",
                        count: {
                            min: 1,
    ...
    event.addJson(`iceandfire:loot_tables/chest/mausoleum_chest.json`, loot_table);
});