onEvent('server.datapack.high_priority', event => {
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:gru,Color:5},{Pattern:gru,Color:14},{Pattern:bri,Color:15},{Pattern:bri,Color:13},{Pattern:tts,Color:15},{Pattern:tts,Color:14},{Pattern:bts,Color:15},{Pattern:bts,Color:14},{Pattern:mc,Color:0},{Pattern:flo,Color:15},{Pattern:flo,Color:14},{Pattern:flo,Color:4}]}}"
                        }]
                    },
                    {
                        name: "mysticalagriculture:emerald_essence",
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/temple/village_jungle_house.json`, loot_table);;
})