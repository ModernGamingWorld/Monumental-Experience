onEvent('server.datapack.high_priority', event => {
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:bt,Color:5},{Pattern:sku,Color:0},{Pattern:sku,Color:12},{Pattern:sku,Color:15},{Pattern:bs,Color:15},{Pattern:rs,Color:15},{Pattern:ls,Color:15},{Pattern:bo,Color:12},{Pattern:tts,Color:12},{Pattern:tts,Color:15},{Pattern:bts,Color:12},{Pattern:bts,Color:15}]}}"
                        }]
                    },
                    {
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/mansions/taiga_storage.json`, loot_table);;
});