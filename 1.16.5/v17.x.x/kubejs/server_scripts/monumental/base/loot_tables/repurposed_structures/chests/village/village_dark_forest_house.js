onEvent('server.datapack.high_priority', event => {
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:gra,Color:5},{Pattern:gra,Color:13},{Pattern:bri,Color:15},{Pattern:bri,Color:12},{Pattern:tts,Color:15},{Pattern:tts,Color:13},{Pattern:bts,Color:15},{Pattern:bts,Color:13},{Pattern:mc,Color:12},{Pattern:flo,Color:15},{Pattern:flo,Color:14},{Pattern:flo,Color:4}]}}"
                        }]
                    },
                    {
                        name: "mysticalagriculture:emerald_essence",
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/village/village_dark_forest_house.json`, loot_table);;
})