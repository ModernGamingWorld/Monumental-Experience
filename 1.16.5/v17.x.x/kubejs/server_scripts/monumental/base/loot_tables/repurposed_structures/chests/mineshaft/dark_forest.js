onEvent('server.datapack.high_priority', event => {
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:rud,Color:4},{Pattern:gra,Color:4},{Pattern:mr,Color:1},{Pattern:ss,Color:15},{Pattern:flo,Color:1},{Pattern:gra,Color:15},{Pattern:gru,Color:1},{Pattern:gru,Color:14},{Pattern:cbo,Color:15},{Pattern:bo,Color:15},{Pattern:drs,Color:14},{Pattern:ss,Color:15}]}}"
                        }]
                    },
                    {
                        name: "minecraft:tnt",
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/mineshaft/dark_forest.json`, loot_table);;
});