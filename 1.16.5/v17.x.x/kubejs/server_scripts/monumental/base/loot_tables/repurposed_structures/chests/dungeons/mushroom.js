onEvent('server.datapack.high_priority', event => {
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:mr,Color:10},{Pattern:flo,Color:10},{Pattern:flo,Color:15},{Pattern:tts,Color:15},{Pattern:tts,Color:15},{Pattern:tts,Color:10},{Pattern:bts,Color:15},{Pattern:bts,Color:15},{Pattern:bts,Color:10},{Pattern:cbo,Color:7},{Pattern:bo,Color:10},{Pattern:cbo,Color:15}]}}"
                        }]
                    },
                    {
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/dungeons/mushroom.json`, loot_table);;
});