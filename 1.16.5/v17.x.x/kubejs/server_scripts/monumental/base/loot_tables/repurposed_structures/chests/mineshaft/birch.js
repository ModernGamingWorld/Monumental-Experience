onEvent('server.datapack.high_priority', event => {
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:rud,Color:0},{Pattern:mr,Color:12},{Pattern:gra,Color:15},{Pattern:gra,Color:12},{Pattern:tt,Color:12},{Pattern:lud,Color:12},{Pattern:gru,Color:0},{Pattern:gru,Color:0},{Pattern:cbo,Color:15},{Pattern:bo,Color:15},{Pattern:drs,Color:0},{Pattern:ss,Color:15}]}}"
                        }]
                    },
                    {
                        name: "minecraft:tnt",
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/mineshaft/birch.json`, loot_table);;
});