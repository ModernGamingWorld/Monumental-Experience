onEvent('player.logged_in', event => {
    ...
    if (!event.player.stages.has('starting_items')) {
        ...
        event.player.give(Item.of('woodenutilities:wooden_helmet', "{Damage: 0}"))
        event.player.give(Item.of('woodenutilities:wooden_chestplate', "{Damage: 0}"))
        event.player.give(Item.of('woodenutilities:wooden_leggings', "{Damage: 0}"))
        event.player.give(Item.of('woodenutilities:wooden_boot', "{Damage: 0}"))
