onEvent('server.datapack.high_priority', event => {
        ...
        pools: [{
            ...
            },
            {
                ...
                entries: [{
                    ...
                    {
                        name: "mysticalagriculture:amethyst_essence",
                        type: "minecraft:item",
                        weight: 10,
                        functions: [{
                            function: "minecraft:set_count",
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:mr,Color:7},{Pattern:flo,Color:7},{Pattern:flo,Color:15},{Pattern:tts,Color:15},{Pattern:tts,Color:15},{Pattern:tts,Color:7},{Pattern:bts,Color:15},{Pattern:bts,Color:15},{Pattern:bts,Color:7},{Pattern:cbo,Color:7},{Pattern:bo,Color:7},{Pattern:cbo,Color:15}]}}"
                        }]
                    },
                    {
                        name: "minecraft:music_disc_11",
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/dungeons/deep.json`, loot_table);;
});