onEvent('server.datapack.high_priority', event => {
        ...
        pools: [{
            ...
            },
            {
                ...
                entries: [{
                    ...
                    {
                        name: "minecraft:mysticalagriculture:gold_essence",
                        type: "minecraft:item",
                        weight: 7,
                        functions: [{
                            function: "minecraft:set_count",
                    ...
                    {
                        name: "mysticalagriculture:prismarine_essence",
                        type: "minecraft:item",
                        weight: 10,
                        functions: [{
                            function: "minecraft:set_count",
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:gra,Color:9},{Pattern:gra,Color:9},{Pattern:gru,Color:9},{Pattern:gru,Color:11},{Pattern:gru,Color:11},{Pattern:sku,Color:15},{Pattern:sku,Color:9},{Pattern:sku,Color:11},{Pattern:cbo,Color:15},{Pattern:bo,Color:15},{Pattern:drs,Color:11},{Pattern:ss,Color:15}]}}"
                        }]
                    },
                    {
                        name: "minecraft:tnt",
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/mineshaft/ocean.json`, loot_table);;
})