onEvent('server.datapack.high_priority', event => {
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:bri,Color:8},{Pattern:ss,Color:8},{Pattern:flo,Color:15},{Pattern:flo,Color:15},{Pattern:flo,Color:8},{Pattern:gru,Color:6},{Pattern:bt,Color:15},{Pattern:bt,Color:15},{Pattern:bt,Color:12},{Pattern:bts,Color:15},{Pattern:bts,Color:14},{Pattern:gra,Color:14}]}}"
                        }]
                    },
                    {
                        name: "minecraft:diamond_horse_armor",
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/pyramid/mushroom_chest.json`, loot_table);;
})