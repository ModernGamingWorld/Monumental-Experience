onEvent('server.datapack.high_priority', event => {
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:gra,Color:1},{Pattern:gra,Color:15},{Pattern:gru,Color:1},{Pattern:gru,Color:4},{Pattern:gru,Color:4},{Pattern:cbo,Color:15},{Pattern:bo,Color:15},{Pattern:sku,Color:15},{Pattern:sku,Color:1},{Pattern:sku,Color:4},{Pattern:drs,Color:4},{Pattern:ss,Color:15}]}}"
                        }]
                    },
                    {
                        name: "minecraft:tnt",
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/mineshaft/desert.json`, loot_table);;
});