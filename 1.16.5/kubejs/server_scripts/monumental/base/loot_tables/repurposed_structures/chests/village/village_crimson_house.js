onEvent('server.datapack.high_priority', event => {
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:gru,Color:1},{Pattern:bri,Color:15},{Pattern:bri,Color:14},{Pattern:tts,Color:14},{Pattern:tts,Color:4},{Pattern:bts,Color:14},{Pattern:bts,Color:4},{Pattern:ms,Color:15},{Pattern:mr,Color:15},{Pattern:ms,Color:14},{Pattern:mr,Color:14},{Pattern:pig,Color:4}]}}"
                        }]
                    },
                    {
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/village/village_crimson_house.json`, loot_table);;
})