onEvent('server.datapack.high_priority', event => {
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:bri,Color:3},{Pattern:bri,Color:0},{Pattern:ss,Color:0},{Pattern:flo,Color:9},{Pattern:flo,Color:0},{Pattern:gru,Color:0},{Pattern:bt,Color:0},{Pattern:bt,Color:0},{Pattern:bt,Color:9},{Pattern:bts,Color:0},{Pattern:bts,Color:9},{Pattern:gra,Color:15}]}}"
                        }]
                    },
                    {
                        name: "minecraft:diamond_horse_armor",
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/pyramid/icy_chest.json`, loot_table);;
})