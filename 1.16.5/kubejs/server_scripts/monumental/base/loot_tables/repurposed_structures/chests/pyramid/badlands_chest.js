            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:bri,Color:0},{Pattern:bri,Color:1},{Pattern:ss,Color:1},{Pattern:flo,Color:15},{Pattern:flo,Color:1},{Pattern:gru,Color:14},{Pattern:bt,Color:15},{Pattern:bt,Color:15},{Pattern:bt,Color:1},{Pattern:bts,Color:15},{Pattern:bts,Color:1},{Pattern:gra,Color:15}]}}"
                        }]
                    },
                    {
                        name: "minecraft:diamond_horse_armor",
