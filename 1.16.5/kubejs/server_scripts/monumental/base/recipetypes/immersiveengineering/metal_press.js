onEvent('recipes', (event) => {
    const recipes = [
        ...
        { output: 'emendatusenigmatica:diamond_plate', input: '#forge:gems/diamond', mold: '#thermal:crafting/dies/plate' },
        { output: 'emendatusenigmatica:emerald_plate', input: '#forge:gems/emerald', mold: '#thermal:crafting/dies/plate' },
        { output: 'emendatusenigmatica:lapis_plate', input: '#forge:gems/lapis', mold: '#thermal:crafting/dies/plate' },
        { output: 'emendatusenigmatica:signalum_plate', input: '#forge:ingots/signalum', mold: '#thermal:crafting/dies/plate' },
        { output: 'emendatusenigmatica:lumium_plate', input: '#forge:ingots/lumium', mold: '#thermal:crafting/dies/plate' },
        { output: 'emendatusenigmatica:enderium_plate', input: '#forge:ingots/enderium', mold: '#thermal:crafting/dies/plate' },
        { output: 'kubejs:compressed_iron_plate', input: '#forge:ingots/compressed_iron', mold: '#thermal:crafting/dies/plate' },
        { output: 'woodenutilities:wooden_plate', input: '#minecraft:planks', mold: '#thermal:crafting/dies/plate' },
//gears
