onEvent('recipes', event => {
    //architects palette
    event.shaped(Item.of('architects_palette:twisted_pressure_plate', 1), [" A ", " A ", " B "], {
    ...
    event.shaped(Item.of('byg:embur_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'byg:embur_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('byg:baobab_pressure_plate', 1), [" A ", " A ", " B "], {
    ...
    event.shaped(Item.of('byg:imparius_pressure_plate', 1), [" A ", " A ", " B "], {
    ...
    //Betterendforge
    event.shaped(Item.of('betterendforge:mossy_glowshroom_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:mossy_glowshroom_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:lacugrove_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:lacugrove_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:end_lotus_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:end_lotus_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:pythadendron_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:pythadendron_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:dragon_tree_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:dragon_tree_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:tenanea_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:tenanea_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:helix_tree_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:helix_tree_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:umbrella_tree_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:umbrella_tree_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:jellyshroom_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:jellyshroom_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:lucernia_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:lucernia_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:flavolite_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:flavolite',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:violecite_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:violecite',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:sulphuric_rock_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:sulphuric_rock',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:thallasium_pressure_plate', 1), [" A ", " A ", " B "], {
        A: '#forge:ingots/thallasium',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('betterendforge:terminite_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'betterendforge:terminite_ingot',
        B: '#forge:tools/crafting_hammer'
    })
    //Blue SKies
    ...
    //Need to be switched back to B: '#forge:tools/wrenches" when #70 resolved
    ...
    event.shaped(Item.of('emendatusenigmatica:cobalt_gear', 1), [" A ", "ABA", " A "], {
        A: '#forge:ingots/cobalt',
        B: 'create:andesite_alloy'
    })
    ...
    event.shaped(Item.of('gateways:small_gate_opener', '{gateway_data:{max_wave_time:500,completion_xp:250,color:"white",name:"gateways.small_ghast_gate",entity:{Entity:{id:"minecraft:ghast"},Weight:1}},opener_name:\'{"translate":"gateways.gate_opener","with":[{"translate":"gateways.small_ghast_gate"}]}\'}'), [" P ", "PDP", " P "], {
        P: 'mysticalagriculture:ghast_essence',
        D: 'xreliquary:salamander_eye',
    })
    event.shaped(Item.of('gateways:small_gate_opener', '{gateway_data:{name:"gateways.small_slime_gate",max_wave_time:600,completion_xp:150,color:"green",entity:{Entity:{id:"minecraft:slime"},Weight:1}},opener_name:\'{"translate":"gateways.gate_opener","with":[{"translate":"gateways.small_slime_gate"}]}\'}'), [" P ", "PDP", " P "], {
        P: 'tconstruct:earth_cake',
        D: 'greater_eye:greater_eye',
    })
    event.shaped(Item.of('gateways:small_gate_opener', '{gateway_data:{max_wave_time:450,completion_xp:100,color:"red",name:"gateways.small_magma_gate",entity:{Entity:{id:"minecraft:magma_cube"},Weight:1}},opener_name:\'{"translate":"gateways.gate_opener","with":[{"translate":"gateways.small_magma_gate"}]}\'}'), [" P ", "PDP", " P "], {
        P: 'tconstruct:magma_cake',
        D: 'greater_eye:greater_eye',
    })
    event.shaped(Item.of('gateways:small_gate_opener', '{gateway_data:{name:"gateways.small_enderman_gate",max_wave_time:1200,completion_xp:500,color:"purple",entity:{Entity:{id:"minecraft:enderman"},Weight:1}},opener_name:\'{"translate":"gateways.gate_opener","with":[{"translate":"gateways.small_enderman_gate"}]}\'}'), [" P ", "PPP", " P "], {
    ...
    //Marquot
    event.shaped(Item.of('marquot:yeetar_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'marquot:yeetar_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('marquot:purpen_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'marquot:purpen_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('marquot:tiran_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'marquot:tiran_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('marquot:wireen_pressure_plate', 1), [" A ", " A ", " B "], {
        A: 'marquot:wireen_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('marquot:plate_1', 1), [" A ", " A ", " B "], {
        A: 'marquot:meed_21_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('marquot:plate_12', 1), [" A ", " A ", " B "], {
        A: 'marquot:shroomium_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('marquot:plate_14', 1), [" A ", " A ", " B "], {
        A: 'marquot:geeg_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('marquot:plate_15', 1), [" A ", " A ", " B "], {
        A: 'marquot:redwood_planks',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('marquot:geewamp_wood_pressure_plate', 1), [" A ", " A ", " B "], {
    ...
    //occultism
    event.shaped(Item.of('occultism:datura_seeds', 1), ["OOO", "OPO", "OOO"], {
        O: 'mysticalagriculture:dirt_essence',
        P: 'forbidden_arcanus:seed_bullet'
    })
    //Pneumaticcraft
