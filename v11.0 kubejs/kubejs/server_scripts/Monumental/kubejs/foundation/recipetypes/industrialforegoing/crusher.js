onEvent('recipes', (event) => {
    const recipes = [
        ...
        },
        {
            ...
            output: { item: 'byg:pink_sand' },
            id: 'enigmatica:industrialforegoing/crusher/pink_sandstone_sand'
        },
        {
            input: { item: 'byg:raw_quartz_block' },
            output: { item: 'byg:quartzite_sand' },
            id: 'enigmatica:industrialforegoing/crusher/quartz_sand'
        },
        {
        ...
        {
            input: { item: 'create:limesand'},
            output: { item: 'emendatusenigmatica:silicon_gem' },
