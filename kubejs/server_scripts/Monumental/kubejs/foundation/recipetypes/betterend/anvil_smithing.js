onEvent('recipes', (event) => {
    ...
    const data = {
        recipes: [
            ...
            {
                id: 'minecraft:redstone_chunk_to_dust',
                input: {
            ...
            {
                id: 'minecraft:coal_chunk_to_dust',
                input: {
            ...
            {
                id: 'emendatusenigmatica:iron_chunk_to_dust',
                input: {
                    item: 'emendatusenigmatica:iron_chunk'
                },
                result: 'emendatusenigmatica:iron_dust',
                level: 2,
                damage: 3
            },
            {
                id: 'ironcoals:charcoal_chunk_to_dust',
                input: {
                    item: 'ironcoals:charcoal_chunk'
                },
