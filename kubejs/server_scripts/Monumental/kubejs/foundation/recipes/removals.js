...
//Building Gadgets Recipes
	...
	event.remove({id: 'buildinggadgets:construction_paste_powder'})
...
//Create Recipes
	...
	event.remove({id: 'create:materials/electron_tube'})
	event.remove({id: 'create:materials/andesite_alloy'})
...
//Extended Crafting
	...
	event.remove({id: 'extendedcrafting:enhanced_ender_catalyst'})
...
//Gateways recipes
	event.remove({id: 'gateways:small_blaze_gate'})
	event.remove({id: 'gateways:small_ghast_gate'})
	event.remove({id: 'gateways:small_slime_gate'})
	event.remove({id: 'gateways:small_magma_gate'})
