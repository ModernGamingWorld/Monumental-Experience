...
//
	...
	//ENDERPEARL DUST
	event.recipes.mekanismCrushing('emendatusenigmatica:ender_dust', 'minecraft:ender_pearl')
	event.recipes.mekanismEnriching('minecraft:ender_pearl', 'emendatusenigmatica:ender_dust')
