ServerEvents.recipes(e => {
	...
	pressureChamberRecipe(['immersiveengineering:wirecoil_electrum', '#forge:silicon', 'extendedcrafting:redstone_catalyst', 'refinedstorage:processor_binding', 'immersiveengineering:wirecoil_electrum'], ['refinedstorage:raw_improved_processor'], 4, 'raw_improved_processor')
	pressureChamberRecipe(['extendedcrafting:black_iron_ingot', '#forge:silicon', 'extendedcrafting:redstone_catalyst', 'refinedstorage:processor_binding'], ['refinedstorage:raw_basic_processor'], 4, 'raw_basic_processor')
	pressureChamberRecipe(['#forge:gears/diamond', '#forge:silicon', 'extendedcrafting:redstone_catalyst', 'refinedstorage:processor_binding'], ['refinedstorage:raw_advanced_processor'], 4, 'raw_advanced_processor')
