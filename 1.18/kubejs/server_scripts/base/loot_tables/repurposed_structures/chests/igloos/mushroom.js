onEvent('server.datapack.high_priority', event => {
            ...
            },
            {
                ...
                entries: [{
                    ...
                    },
                    {
                        ...
                        functions: [{
                            function: "set_nbt",
                            tag: "{BlockEntityTag:{Patterns:[{Pattern:bri,Color:7},{Pattern:bri,Color:14},{Pattern:gru,Color:15},{Pattern:gru,Color:15},{Pattern:flo,Color:14},{Pattern:moj,Color:15},{Pattern:sku,Color:12},{Pattern:mr,Color:1},{Pattern:bt,Color:15},{Pattern:mc,Color:4},{Pattern:bts,Color:15},{Pattern:bts,Color:10}]}}"
                        }]
                    },
                    {
                        name: "mysticalagriculture:emerald_essence",
    ...
    event.addJson(`repurposed_structures:loot_tables/chests/igloos/mushroom.json`, loot_table);;
});