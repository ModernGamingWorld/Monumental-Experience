onEvent('recipes', event => {
    //ae2
    /*event.shaped(Item.of('ae2:engineering_processor_press', 1), ["BBB", "BCB", "BBB"], {
        B: 'mysticalagriculture:certus_quartz_essence',
        C: '#forge:gems/mana_diamond'
    })*/
    event.shaped(Item.of('ae2:silicon_press', 1), ["BBB", "BCB", "BBB"], {
        B: 'mysticalagriculture:certus_quartz_essence',
        C: 'mysticalagriculture:silicon_essence'
    })
    /*event.shaped(Item.of('ae2:calculation_processor_press', 1), ["BBB", "BCB", "BBB"], {
        B: 'mysticalagriculture:certus_quartz_essence',
        C: 'jecalculation:item_calculator_math'
    })*/
    event.shaped(Item.of('ae2:logic_processor_press', 1), ["BBB", "BCB", "BBB"], {
        B: 'mysticalagriculture:certus_quartz_essence',
        C: '#forge:ingots/electrum'
    })
    event.shaped(Item.of('ae2:quartz_growth_accelerator', 1), ["aba", "cdc", "aba"], {
        c: 'ae2:quartz_glass',
        a: 'kubejs:compressed_iron_plate',
        b: 'ae2:fluix_glass_cable',
        d: 'ae2:fluix_block'
    })
    event.shaped(Item.of('ae2:quantum_ring', 1), ["aba", "cde", "aba"], {
    ...
    event.shaped(Item.of('ae2:crafting_unit', 1), ["aba", "cdc", "aba"], {
        a: 'kubejs:compressed_iron_plate',
        d: 'ae2:logic_processor',
        c: 'ae2:fluix_glass_cable',
        b: 'ae2:calculation_processor'
    })
    /*event.shaped(Item.of('ae2:blank_pattern', 2), ["ABA", "BCB", "DDD"], {
        A: 'ae2:quartz_glass',
        B: '#forge:ingots/refined_glowstone',
        C: 'ae2:charged_certus_quartz_crystal',
        D: 'kubejs:compressed_iron_plate'
    })*/
    event.shaped(Item.of('ae2:import_bus', 1), [" a ", "bcb"], {
        a: 'ae2:annihilation_core',
        b: 'kubejs:compressed_iron_plate',
        c: '#forge:piston'
    })
    event.shaped(Item.of('ae2:annihilation_plane', 1), ["aaa", "bcb"], {
        a: '#forge:gems/fluix',
        b: 'kubejs:compressed_iron_plate',
        c: 'ae2:annihilation_core'
    })
    event.shaped(Item.of('ae2:annihilation_plane', 1), ["ab", "cb", "ab"], {
        a: '#forge:gems/fluix',
        b: 'kubejs:compressed_iron_plate',
        c: 'ae2:annihilation_core'
    })
    /*event.shaped(Item.of('ae2:formation_plane', 1), ["aaa", "bcb"], {
        a: '#forge:gems/fluix',
        b: '#forge:plates/enderium',
        c: 'ae2:formation_core'
    })
    event.shaped(Item.of('ae2:formation_plane', 1), ["ab", "cb", "ab"], {
        a: '#forge:gems/fluix',
        b: '#forge:plates/enderium',
        c: 'ae2:formation_core'
    })*/
    event.shaped(Item.of('ae2:export_bus', 1), ["aba", " c "], {
        a: 'kubejs:compressed_iron_plate',
    ...
    //Cyclic
    event.shaped(Item.of('cyclic:netherite_pressure_plate', 1), [" B ", " A ", " A "], {
        A: '#forge:nuggets/netherite',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('cyclic:obsidian_pressure_plate', 1), [" B ", " A ", " A "], {
        A: '#forge:obsidian',
        B: '#forge:tools/crafting_hammer'
    })
    event.shaped(Item.of('cyclic:copper_pressure_plate', 1), [" B ", " A ", " A "], {
    ...
    event.shaped(Item.of('sophisticatedbackpacks:upgrade_base', 2), ["SIS", "ILI", "SIS"], {
        L: '#forge:leather',
        I: '#forge:ingots/iron',
