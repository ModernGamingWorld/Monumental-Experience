onEvent('recipes', event => {
    ...
    //AE2 Recipes
    event.remove({
        id: 'ae2:tools/certus_quartz_pickaxe'
    })
    event.remove({
        id: 'ae2:tools/nether_quartz_pickaxe'
    })
    event.remove({
        id: 'ae2:tools/certus_quartz_axe'
    })
    event.remove({
        id: 'ae2:tools/nether_quartz_axe'
    })
    event.remove({
        id: 'ae2:tools/certus_quartz_spade'
    })
    event.remove({
        id: 'ae2:tools/nether_quartz_spade'
    })
    event.remove({
        id: 'ae2:tools/certus_quartz_sword'
    })
    event.remove({
        id: 'ae2:tools/nether_quartz_sword'
    })
    event.remove({
        id: 'ae2:tools/certus_quartz_hoe'
    })
    event.remove({
        id: 'ae2:tools/nether_quartz_hoe'
    })
    event.remove({
        id: 'ae2:network/blocks/spatial_anchor'
    })
    event.remove({
        id: 'ae2:network/cells/view_cell_storage'
    })
    event.remove({
    ...
    event.remove({
        id: 'ae2:network/cells/item_storage_cell_1k_storage'
    })
    event.remove({
        id: 'ae2:network/cells/item_storage_cell_4k'
    })
    event.remove({
        id: 'ae2:network/cells/item_storage_cell_4k_storage'
    })
    event.remove({
        id: 'ae2:network/cells/spatial_storage_cell_128_cubed'
    })
    event.remove({
        id: 'ae2:network/cells/spatial_storage_cell_128_cubed_storage'
    })
    event.remove({
        id: 'ae2:network/cells/spatial_storage_cell_16_cubed'
    })
    event.remove({
        id: 'ae2:network/cells/spatial_storage_cell_16_cubed_storage'
    })
    event.remove({
        id: 'ae2:network/cells/spatial_storage_cell_2_cubed'
    })
    event.remove({
        id: 'ae2:network/cells/spatial_storage_cell_2_cubed_storage'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_components_cell_64k_part'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_components_cell_16k_part'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_components_cell_4k_part'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_components_cell_1k_part'
    })
    event.remove({
    ...
    event.remove({
        id: 'ae2:network/blocks/fluid_interfaces_interface'
    })
    event.remove({
    ...
    event.remove({
        id: 'ae2:network/parts/export_bus_fluid'
    })
    event.remove({
        id: 'ae2:network/parts/import_bus'
    })
    event.remove({
        id: 'ae2:network/parts/import_bus_fluid'
    })
    event.remove({
        id: 'ae2:network/parts/planes_annihilation_fluid'
    })
    event.remove({
        id: 'ae2:network/parts/planes_annihilation_fluid_alt'
    })
    event.remove({
        id: 'ae2:network/parts/planes_annihilation_alt'
    })
    event.remove({
        id: 'ae2:network/parts/planes_annihilation_alt2'
    })
    event.remove({
        id: 'ae2:network/parts/planes_formation_alt'
    })
    event.remove({
        id: 'ae2:network/parts/planes_formation'
    })
    event.remove({
        id: 'ae2:network/parts/planes_formation_fluid_alt'
    })
    event.remove({
        id: 'ae2:network/parts/planes_formation_fluid'
    })
    event.remove({
    ...
    event.remove({
        id: 'ae2:misc/grindstone'
    })
    event.remove({
        id: 'ae2:misc/grindstone_woodengear'
    })
    event.remove({
        id: 'ae2:misc/meteors_sky_compass'
    })
    event.remove({
    ...
    event.remove({
        id: 'ae2:decorative/certus_quartz_block'
    })
    event.remove({
        id: 'ae2:misc/deconstruction_certus_quartz_block'
    })
    event.remove({
    ...
    event.remove({
        id: 'ae2:network/cells/item_storage_cell_16k_storage'
    })
    event.remove({
        id: 'ae2:network/cells/item_storage_cell_64k_storage'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_cell_1k'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_cell_1k_storage'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_cell_4k'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_cell_4k_storage'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_cell_16k'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_cell_16k_storage'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_cell_64k'
    })
    event.remove({
        id: 'ae2:network/cells/fluid_storage_cell_64k_storage'
    })
    event.remove({
        id: 'ae2:crank'
    })
    ...
    event.remove({
        id: 'ae2:decorative/fluix_block'
    })
    event.remove({
        id: 'ae2:misc/deconstruction_fluix_block'
    })
    event.remove({
        id: 'ae2:smelting/gold_ingot'
    })
    event.remove({
        id: 'ae2:smelting/iron_ingot'
    })
    event.remove({
        id: 'ae2:smelting/gold_ingot'
    })
    event.remove({
        id: 'ae2:network/parts/annihilation_plane_alt2'
    })
    event.remove({
    ...
    event.remove({
        id: 'bigreactors:crafting/yellorium_ingot'
    })
    event.remove({
        id: 'bigreactors:graphite_dust'
    })
    event.remove({
        id: 'bigreactors:crafting/yellorium_block'
    })
    ...
    event.remove({
        id: 'biomesoplenty:fir_pressure_plate'
    })
    event.remove({
        id: 'biomesoplenty:redwood_pressure_plate'
    })
    event.remove({
        id: 'biomesoplenty:cherry_pressure_plate'
    })
    event.remove({
        id: 'biomesoplenty:mahogany_pressure_plate'
    })
    event.remove({
        id: 'biomesoplenty:jacaranda_pressure_plate'
    })
    event.remove({
        id: 'biomesoplenty:palm_pressure_plate'
    })
    event.remove({
        id: 'biomesoplenty:willow_pressure_plate'
    })
    event.remove({
        id: 'biomesoplenty:dead_pressure_plate'
    })
    event.remove({
        id: 'biomesoplenty:magic_pressure_plate'
    })
    event.remove({
        id: 'biomesoplenty:umbran_pressure_plate'
    })
    event.remove({
        id: 'biomesoplenty:hellbark_pressure_plate'
    })
    ...
    event.remove({
        id: 'cyclic:netherite_pressure_plate'
    })
    event.remove({
        id: 'cyclic:obsidian_pressure_plate'
    })
    event.remove({
        id: 'cyclic:copper_pressure_plate'
    })
    event.remove({
        id: 'cyclic:hopper'
    })
    ...
    event.remove({
        id: 'cyclic:copper_pickaxe'
    })
    event.remove({
        id: 'cyclic:amethyst_pickaxe'
    })
    event.remove({
    ...
    event.remove({
        id: 'enigmaticlegacy:etherium_hoe'
    })
    ...
    event.remove({
        id: 'forbidden_arcanus:fungyss_pressure_plate'
    })
    event.remove({
    ...
    //Hexerei Recipes
    event.remove({
        id: 'hexerei:mahogany_pressure_plate'
    })
    event.remove({
        id: 'hexerei:willow_pressure_plate'
    })
    ...
    event.remove({
        id: 'mna:vinteum_bar_blast_furnace'
    })
    event.remove({
        id: 'mna:vinteum_coated_iron'
    })
    event.remove({
        id: 'mna:purified_vinteum_coated_iron'
    })
    event.remove({
        id: 'mna:vinteum_bar'
    })
    ...
    event.remove({
        id: 'mna:purified_vinteum_dust'
    })
    event.remove({
        id: 'mna:arcane_compound'
    })
    event.remove({
        id: 'mna:stone_runes/rune_bag'
    })
    event.remove({
        id: 'mna:stone_runes/rune_blank'
    })
    event.remove({
        id: 'mna:purified_vinteum_bar_blast_furnace'
    })
    event.remove({
        id: 'mna:purified_vinteum_bar'
    })
    ...
    event.remove({
        id: 'supplementaries:recipes/rope_2'
    })
    event.remove({
        id: 'supplementaries:recipes/rope'
    })
    ...
    event.remove({
        id: 'valhelsia_structures:lapidified_jungle_pressure_plate'
    })
